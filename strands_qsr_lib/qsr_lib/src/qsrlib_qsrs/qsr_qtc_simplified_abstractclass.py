...
class QSR_QTC_Simplified_Abstractclass(QSR_Dyadic_Abstractclass):
    ...
    def _create_qtc_representation(self, pos_k, pos_l, quantisation_factor=0, angle_quantisation_factor=0):
        ...
        k = np.append(
            ...
            self._test_constraint_side (
                pos_k,
                RL_ext,
                quantisation_factor=quantisation_factor,            
                angle_quantisation_factor=angle_quantisation_factor) 
            # self._test_constraint(
            #     pos_k,
            #     RL_ext,
            #     quantisation_factor=quantisation_factor,
    ...
    def _test_constraint_side(self, pos, line, quantisation_factor=0, angle_quantisation_factor=0):
        """Test for distance and side constraint using the double cross.
